...
# === SIDEBAR MANUAL (SIN st.page_link) ===
with st.sidebar:
    st.image("https://via.placeholder.com/100", caption="Stock Zero")
    st.markdown("### Navegación")
    st.markdown("[Home](?page=home)")
    st.markdown("[Archivos](?page=1_Archivos)")
    st.markdown("[Inventario](?page=2_Inventario)")
    st.markdown("[Análisis](?page=3_Analisis)")
    st.markdown("[Productos](?page=4_Productos)")
